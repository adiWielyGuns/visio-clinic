            ...
            <div class="add-contact">
                <div class="container--small">
                    <form class="form--add-contact" id="form-data">
                        ...
                        <div class="form-group {{ Auth::user()->role->name == 'Terapis' ? 'disabled' : '' }}">
                            <label>Dokter</label>
                            <select class="select select-contact-group" id="users_id" name="users_id" title="Pilih Dokter">
                                @foreach ($dokter as $item)
                                    <option {{ Auth::user()->id == $item->id ? 'selected' : '' }}
                                        value="{{ $item->id }}">
                                        {{ $item->name }}</option>
                                @endforeach
                            </select>
